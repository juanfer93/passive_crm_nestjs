      ...
      messages: [
        {
          ...
          content: [
            ...
            'document_status must always be a string. Use "confirmed" when the lead clearly confirms they have ID and bank account, or when an image description clearly shows both identity documentation and bank account proof such as a bank statement.',
